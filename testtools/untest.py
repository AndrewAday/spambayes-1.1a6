...
>>>>>>> Stashed changes
    ...
    while keep_going:
        msg = choice(au_v.driver.tester.train_examples[1])
...
<<<<<<< Updated upstream
        ...
        with open("C:\Users\Alex\Desktop\clusterstats" + str(trial_number) + ".txt", 'w') as outfile:
        ...
        with open("C:\Users\Alex\Desktop\clusterstats_v" + str(trial_number) + ".txt", 'w') as outfile:
